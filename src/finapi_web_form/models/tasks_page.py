...
class TasksPage(BaseModel):
    ...
    TasksPage
    """ # noqa: E501
    items: Annotated[List[Task], Field(min_length=0, max_length=500)] = Field(description="Page of resources")
    paging: Paging
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TasksPage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TasksPage from a dict"""
        if obj is None:
            return None
