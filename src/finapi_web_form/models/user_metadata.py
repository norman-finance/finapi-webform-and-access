...
class UserMetadata(BaseModel):
    ...
    """ # noqa: E501
    ip_address: Annotated[str, Field(min_length=0, strict=True, max_length=64)] = Field(description="The IP address of the user's device", alias="ipAddress")
    device_os: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The user's device and/or operating system identification", alias="deviceOs")
    user_agent: Annotated[str, Field(min_length=0, strict=True, max_length=1024)] = Field(description="The user's web browser or other client device identification", alias="userAgent")
    __properties: ClassVar[List[str]] = ["ipAddress", "deviceOs", "userAgent"]
