...
class PaymentWithAccountRecipient(BaseModel):
    """
    Payment Recipient
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["name", "iban", "bic", "bankName", "address"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentWithAccountRecipient from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentWithAccountRecipient from a dict"""
        if obj is None:
            return None
