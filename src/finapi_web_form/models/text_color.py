...
class TextColor(BaseModel):
    """
    The color of various text elements in web form
    """ # noqa: E501
    primary: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The primary color of the text.<br/><strong>NOTE:</strong> If no value is provided, then the following value will be applied by default when web form is opened: <code>#232323</code>")
    secondary: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The secondary color of the text (e.g. login hint, summaries, etc). Can be the same as primary color.<br/><strong>NOTE:</strong> If no value is provided, then the following value will be applied by default when web form is opened: <code>#848484</code>")
