...
class PaymentWithAccountDetails(BaseModel):
    """
    ...
    sender: PaymentWithAccountSender
    ...
    orders: Annotated[List[PaymentWithAccountOrder], Field(min_length=1, max_length=15000)] = Field(description="Payment orders")
    __properties: ClassVar[List[str]] = ["executionDate", "batchBookingPreferred", "profileId", "redirectUrl", "callbacks", "sender", "instantPayment", "orders"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentWithAccountDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentWithAccountDetails from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "sender": PaymentWithAccountSender.from_dict(obj["sender"]) if obj.get("sender") is not None else None,
            "instantPayment": obj.get("instantPayment") if obj.get("instantPayment") is not None else False,
            "orders": [PaymentWithAccountOrder.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None
        })
        return _obj
