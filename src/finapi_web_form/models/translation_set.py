...
class TranslationSet(BaseModel):
    ...
    TranslationSet
    """ # noqa: E501
    id: Annotated[str, Field(min_length=36, strict=True, max_length=36)] = Field(description="Globally unique translation set's identifier")
    created_at: datetime = Field(description="The timestamp when the translation set was created in the format <code>yyyy-MM-dd'T'HH:mm:ss.SSSZ</code>.", alias="createdAt")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdAt", "cs", "de", "en", "es", "fr", "it", "nl", "pl", "ro", "sk", "tr"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TranslationSet from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TranslationSet from a dict"""
        if obj is None:
            return None
