...
class DirectDebitOrder(BaseModel):
    """
    Direct debit order
    """ # noqa: E501
    payer: PaymentPayer
    ...
    mandate_id: Annotated[str, Field(min_length=0, strict=True, max_length=270)] = Field(description="Mandate ID that this direct debit order is based on.", alias="mandateId")
    mandate_date: date = Field(description="Date of the mandate that this direct debit order is based on, in the format <code>YYYY-MM-DD</code>", alias="mandateDate")
    creditor_id: Annotated[str, Field(min_length=0, strict=True, max_length=35)] = Field(description="Creditor ID of the source account's holder", alias="creditorId")
    __properties: ClassVar[List[str]] = ["payer", "amount", "purpose", "sepaPurposeCode", "endToEndId", "mandateId", "mandateDate", "creditorId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DirectDebitOrder from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DirectDebitOrder from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "payer": PaymentPayer.from_dict(obj["payer"]) if obj.get("payer") is not None else None,
