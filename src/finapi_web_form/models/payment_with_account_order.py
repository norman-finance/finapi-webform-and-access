...
class PaymentWithAccountOrder(BaseModel):
    """
    Payment order
    """ # noqa: E501
    recipient: PaymentWithAccountRecipient
    ...
    sepa_purpose_code: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="SEPA purpose code, according to ISO 20022, external codes set.<br/>Please note that the SEPA purpose code may be ignored by some banks. Only applicable for the SEPA transfers and will be discarded for other transfers.", alias="sepaPurposeCode")
    end_to_end_id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=35)]] = Field(default=None, description="End-To-End ID for the transfer transaction. Only applicable for the SEPA transfers and will be discarded for other transfers.", alias="endToEndId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentWithAccountOrder from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentWithAccountOrder from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "recipient": PaymentWithAccountRecipient.from_dict(obj["recipient"]) if obj.get("recipient") is not None else None,
