...
class Callbacks(BaseModel):
    """
    Callbacks for the instantiated web form. Find more info in the <a href='https://documentation.finapi.io/webform/For-best-results!.2477654019.html#Forbestresults!-Enhanceyourexperience!' target='_blank'>Web Form 2.0 Public Documentation</a>.
    """ # noqa: E501
    finalised: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=2048)]] = Field(default=None, description="URL to which finAPI sends the notification message after the web form is finalised (either completed successfully or with an error, or aborted by the user).<br/>finAPI will call this URL with HTTP method POST ignoring the response of the target endpoint. Only HTTPS URLs are allowed.")
    __properties: ClassVar[List[str]] = ["finalised"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Callbacks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Callbacks from a dict"""
        if obj is None:
            return None
