...
class Recipient(BaseModel):
    ...
    Recipient details
    """ # noqa: E501
    iban: Annotated[str, Field(min_length=0, strict=True, max_length=34)] = Field(description="A normalized (without spaces) IBAN of the counterparty's account.<br/><strong>NOTE:</strong> Must belong to SEPA area.")
    ...
    __properties: ClassVar[List[str]] = ["iban", "name"]
