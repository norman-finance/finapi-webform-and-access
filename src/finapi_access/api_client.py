...
from finapi_access.api_response import ApiResponse, T as ApiResponseT
import finapi_access.models
from finapi_access import rest
from finapi_access.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(finapi_access.models, klass)
