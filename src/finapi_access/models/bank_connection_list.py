...
class BankConnectionList(BaseModel):
    ...
    """ # noqa: E501
    connections: List[BankConnection] = Field(description="List of bank connections<br/> <strong>Type:</strong> BankConnection")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BankConnectionList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BankConnectionList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "connections": [BankConnection.from_dict(_item) for _item in obj["connections"]] if obj.get("connections") is not None else None
        })
        return _obj
