...
class LoginCredentialResource(BaseModel):
    """
    Container for a bank login credential
    """ # noqa: E501
    label: StrictStr = Field(description="Label for this login credential, as we suggest to show it to the user.")
    value: Optional[StrictStr] = Field(default=None, description="Stored value for this login credential. Please NOTE:<br/>If your client has no license for processing banking credentials, or if this field contains a value that requires password protection (e.g. PIN), then this field will always be 'XXXXX'.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoginCredentialResource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoginCredentialResource from a dict"""
        if obj is None:
            return None
