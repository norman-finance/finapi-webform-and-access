...
class DomesticMoneyTransferMandatoryFields(BaseModel):
    """
    Set of mandatory fields for domestic money transfers via this interface.
    """ # noqa: E501
    end_to_end_id: Optional[StrictBool] = Field(default=None, description="Indicates whether the endToEndId must be provided for domestic money transfers.", alias="endToEndId")
    __properties: ClassVar[List[str]] = ["endToEndId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DomesticMoneyTransferMandatoryFields from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DomesticMoneyTransferMandatoryFields from a dict"""
        if obj is None:
            return None
