...
class AccountInterface(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountInterface from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountInterface from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "paymentCapabilities": AccountInterfacePaymentCapabilities.from_dict(obj["paymentCapabilities"]) if obj.get("paymentCapabilities") is not None else None,
