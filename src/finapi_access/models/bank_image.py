...
class BankImage(BaseModel):
    ...
    """ # noqa: E501
    url: StrictStr = Field(description="The URL to the bank's image resource.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BankImage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BankImage from a dict"""
        if obj is None:
            return None
