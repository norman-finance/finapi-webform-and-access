...
class ErrorMessage(BaseModel):
    ...
    """ # noqa: E501
    errors: List[ErrorDetails] = Field(description="List of errors<br/> <strong>Type:</strong> ErrorDetails")
    var_date: datetime = Field(description="<strong>Format:</strong> 'YYYY-MM-DD'T'HH:MM:SS.SSSXXX' (RFC 3339, section 5.6)<br/>Server date of when the error(s) occurred", alias="date")
    request_id: StrictStr = Field(description="ID of the request that caused this error. This is either what you have passed for the header 'X-Request-Id', or an auto-generated ID in case you didn't pass any value for that header.<br/><br/>", alias="requestId")
    endpoint: StrictStr = Field(description="The service endpoint that was called")
    auth_context: StrictStr = Field(description="Information about the authorization context of the service call", alias="authContext")
    bank: Optional[StrictStr] = Field(default=None, description="BLZ and name (in format \"<BLZ> - <name>\") of a bank that was used for the original request")
    __properties: ClassVar[List[str]] = ["errors", "date", "requestId", "endpoint", "authContext", "bank"]
