...
class UserCreateParams(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserCreateParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserCreateParams from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "phone": obj.get("phone"),
            "isAutoUpdateEnabled": obj.get("isAutoUpdateEnabled") if obj.get("isAutoUpdateEnabled") is not None else False
        })
        return _obj
