...
class CertisTransactionData(BaseModel):
    """
    Fields as defined by <a href='https://www.cnb.cz/en/payments/certis/' target='_blank'>CERTIS</a>.
    """ # noqa: E501
    variable_symbol: Optional[StrictStr] = Field(default=None, description="CERTIS variable symbol (VS). Maximum length: 10", alias="variableSymbol")
    constant_symbol: Optional[StrictStr] = Field(default=None, description="CERTIS constant symbol (KS). Maximum length: 10", alias="constantSymbol")
    specific_symbol: Optional[StrictStr] = Field(default=None, description="CERTIS specific symbol (SS). Maximum length: 10", alias="specificSymbol")
    __properties: ClassVar[List[str]] = ["variableSymbol", "constantSymbol", "specificSymbol"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CertisTransactionData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CertisTransactionData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "variableSymbol": obj.get("variableSymbol"),
            "constantSymbol": obj.get("constantSymbol"),
            "specificSymbol": obj.get("specificSymbol")
        })
        return _obj
