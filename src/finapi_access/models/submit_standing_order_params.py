...
class SubmitStandingOrderParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["standingOrderId", "bankingInterface", "loginCredentials", "redirectUrl", "multiStepAuthentication"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubmitStandingOrderParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubmitStandingOrderParams from a dict"""
        if obj is None:
            return None
