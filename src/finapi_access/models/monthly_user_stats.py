...
class MonthlyUserStats(BaseModel):
    ...
    """ # noqa: E501
    month: StrictStr = Field(description="The month that the contained information applies to, in the format 'YYYY-MM'.")
    min_bank_connection_count: StrictInt = Field(description="Minimum count of bank connections that this user has had at any point during the month.", alias="minBankConnectionCount")
    max_bank_connection_count: StrictInt = Field(description="Maximum count of bank connections that this user has had at any point during the month.", alias="maxBankConnectionCount")
    __properties: ClassVar[List[str]] = ["month", "minBankConnectionCount", "maxBankConnectionCount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MonthlyUserStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MonthlyUserStats from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "month": obj.get("month"),
            "minBankConnectionCount": obj.get("minBankConnectionCount"),
            "maxBankConnectionCount": obj.get("maxBankConnectionCount")
        })
        return _obj
