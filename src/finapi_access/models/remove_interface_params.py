...
class RemoveInterfaceParams(BaseModel):
    """
    ...
    banking_interface: BankingInterface = Field(description="The interface which you want to remove.<br/> <strong>Type:</strong> BankingInterface", alias="bankingInterface")
    __properties: ClassVar[List[str]] = ["bankConnectionId", "bankingInterface"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RemoveInterfaceParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RemoveInterfaceParams from a dict"""
        if obj is None:
            return None
