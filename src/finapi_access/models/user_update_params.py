...
class UserUpdateParams(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "email": obj.get("email"),
            "phone": obj.get("phone"),
            "isAutoUpdateEnabled": obj.get("isAutoUpdateEnabled")
        })
        return _obj
