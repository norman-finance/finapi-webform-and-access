...
class DomesticMoneyTransferConstraints(BaseModel):
    """
    Payment constraints that apply to domestic money transfers.
    """ # noqa: E501
    mandatory_fields: Optional[DomesticMoneyTransferMandatoryFields] = Field(default=None, alias="mandatoryFields")
    __properties: ClassVar[List[str]] = ["mandatoryFields"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DomesticMoneyTransferConstraints from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DomesticMoneyTransferConstraints from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "mandatoryFields": DomesticMoneyTransferMandatoryFields.from_dict(obj["mandatoryFields"]) if obj.get("mandatoryFields") is not None else None
        })
        return _obj
