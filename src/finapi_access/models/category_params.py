...
class CategoryParams(BaseModel):
    ...
    Category parameters
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = Field(description="Name of the category.")
    parent_id: Optional[StrictInt] = Field(default=None, description="Identifier of the parent category, if the new category should be created as a sub-category. Must point to a main category in this case. If the new category should be a main category itself, this field must remain unset.", alias="parentId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CategoryParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CategoryParams from a dict"""
        if obj is None:
            return None
