...
class CashFlowList(BaseModel):
    ...
    Cash flows
    """ # noqa: E501
    cash_flows: List[CashFlow] = Field(description="Array of cash flows<br/> <strong>Type:</strong> CashFlow", alias="cashFlows")
    total_income: Union[StrictFloat, StrictInt] = Field(description="The total income", alias="totalIncome")
    total_spending: Union[StrictFloat, StrictInt] = Field(description="The total spending", alias="totalSpending")
    total_balance: Union[StrictFloat, StrictInt] = Field(description="The total balance", alias="totalBalance")
    __properties: ClassVar[List[str]] = ["cashFlows", "totalIncome", "totalSpending", "totalBalance"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CashFlowList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CashFlowList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "cashFlows": [CashFlow.from_dict(_item) for _item in obj["cashFlows"]] if obj.get("cashFlows") is not None else None,
