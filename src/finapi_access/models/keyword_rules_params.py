...
class KeywordRulesParams(BaseModel):
    """
    Params for creation of keyword rules
    """ # noqa: E501
    keyword_rules: Annotated[List[KeywordRuleParams], Field(min_length=1, max_length=100)] = Field(description="Keyword rule definitions.<br/> <strong>Type:</strong> KeywordRuleParams", alias="keywordRules")
    __properties: ClassVar[List[str]] = ["keywordRules"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KeywordRulesParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KeywordRulesParams from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "keywordRules": [KeywordRuleParams.from_dict(_item) for _item in obj["keywordRules"]] if obj.get("keywordRules") is not None else None
        })
        return _obj
