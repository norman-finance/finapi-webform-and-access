...
class TppCredentials(BaseModel):
    """
    A container for the TPP client credentials data
    """ # noqa: E501
    id: StrictInt = Field(description="The credential identifier.")
    label: StrictStr = Field(description="Label of tpp client credentials set.")
    tpp_authentication_group_id: StrictInt = Field(description="TPP Authentication Group ID.", alias="tppAuthenticationGroupId")
    valid_from: date = Field(description="<strong>Format:</strong> 'YYYY-MM-DD'<br/>Valid from date.", alias="validFrom")
    valid_until: Optional[date] = Field(default=None, description="<strong>Format:</strong> 'YYYY-MM-DD'<br/>Valid until date.", alias="validUntil")
    __properties: ClassVar[List[str]] = ["id", "label", "tppAuthenticationGroupId", "validFrom", "validUntil"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TppCredentials from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TppCredentials from a dict"""
        if obj is None:
            return None
