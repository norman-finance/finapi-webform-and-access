...
class EditBankConnectionParams(BaseModel):
    """
    Container for bank connection edit params
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=64)]] = Field(default=None, description="New name for the bank connection. If you do not want to change the current name let this field remain unset. If you want to clear the current name, set the field's value to an empty string (\"\").<br/><br/><strong>NOTE:</strong> If you are a Web Form 2.0 customer, and would like to update the name of your bank connection, please use the API parameter.")
    banking_interface: Optional[BankingInterface] = Field(default=None, description="The interface for which you want to edit data. Must be given when you pass 'loginCredentials' and/or a 'defaultTwoStepProcedureId'.<br/> <strong>Type:</strong> BankingInterface", alias="bankingInterface")
    login_credentials: Optional[List[LoginCredential]] = Field(default=None, description="Set of login credentials that you want to edit. Must be passed in combination with the 'bankingInterface' field. The labels that you pass must match with the login credential labels that the respective interface defines. If you want to clear the stored value for a credential, you can pass an empty string (\"\") as value. Note that any change in the credentials will automatically remove the saved consent data associated with those credentials.<br/><br/><strong>NOTE:</strong> If you are a  Web Form 2.0 customer, and would like to allow your end-users to change the credentials they have stored in our system, then please navigate <a target=\"_blank\" href='?product=web_form_2.0#post-/api/tasks/backgroundUpdate' target='_blank'>here</a> to implement the same functionality.<br/> <strong>Type:</strong> LoginCredential", alias="loginCredentials")
    default_two_step_procedure_id: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=512)]] = Field(default=None, description="New default two-step-procedure. Must match the 'procedureId' of one of the procedures that are listed in the bank connection. If you do not want to change this field let it remain unset. If you want to clear the current default two-step-procedure, set the field's value to an empty string (\"\").<br/><br/><strong>NOTE:</strong> If you are a Web Form 2.0 customer and would like to allow your end users to update their preferred TAN procedure that is stored in our system, then please navigate <a target=\"_blank\" href='?product=web_form_2.0#post-/api/tasks/backgroundUpdate'>here</a> to implement the same functionality.", alias="defaultTwoStepProcedureId")
    __properties: ClassVar[List[str]] = ["name", "bankingInterface", "loginCredentials", "defaultTwoStepProcedureId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EditBankConnectionParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EditBankConnectionParams from a dict"""
        if obj is None:
            return None
