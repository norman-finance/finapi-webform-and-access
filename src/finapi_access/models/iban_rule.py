...
class IbanRule(BaseModel):
    ...
    iban: StrictStr = Field(description="The IBAN for this rule")
    __properties: ClassVar[List[str]] = ["id", "category", "direction", "creationDate", "iban"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IbanRule from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IbanRule from a dict"""
        if obj is None:
            return None
