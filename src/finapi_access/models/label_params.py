...
class LabelParams(BaseModel):
    ...
    Label's name
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=288)] = Field(description="Label's name.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LabelParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LabelParams from a dict"""
        if obj is None:
            return None
