...
class PageablePendingTransactionResources(BaseModel):
    """
    Container for a page of pending transactions
    """ # noqa: E501
    pending_transactions: List[PendingTransaction] = Field(description="Array of pending transactions (for the requested page)<br/> <strong>Type:</strong> PendingTransaction", alias="pendingTransactions")
    paging: Paging = Field(description="Information for pagination<br/> <strong>Type:</strong> Paging")
    __properties: ClassVar[List[str]] = ["pendingTransactions", "paging"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageablePendingTransactionResources from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in pending_transactions (list)
        _items = []
        if self.pending_transactions:
            for _item in self.pending_transactions:
                if _item:
                    _items.append(_item.to_dict())
            _dict['pendingTransactions'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageablePendingTransactionResources from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "pendingTransactions": [PendingTransaction.from_dict(_item) for _item in obj["pendingTransactions"]] if obj.get("pendingTransactions") is not None else None,
