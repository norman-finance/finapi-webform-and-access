...
class CheckCategorizationData(BaseModel):
    """
    Transactions data for categorization check
    """ # noqa: E501
    transaction_data: List[CheckCategorizationTransactionData] = Field(description="Set of transaction data<br/> <strong>Type:</strong> CheckCategorizationTransactionData", alias="transactionData")
    __properties: ClassVar[List[str]] = ["transactionData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CheckCategorizationData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CheckCategorizationData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "transactionData": [CheckCategorizationTransactionData.from_dict(_item) for _item in obj["transactionData"]] if obj.get("transactionData") is not None else None
        })
        return _obj
