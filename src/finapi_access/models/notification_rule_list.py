...
class NotificationRuleList(BaseModel):
    ...
    """ # noqa: E501
    notification_rules: List[NotificationRule] = Field(description="List of notification rules<br/> <strong>Type:</strong> NotificationRule", alias="notificationRules")
    __properties: ClassVar[List[str]] = ["notificationRules"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NotificationRuleList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NotificationRuleList from a dict"""
        if obj is None:
            return None
