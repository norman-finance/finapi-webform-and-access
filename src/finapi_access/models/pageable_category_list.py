...
class PageableCategoryList(BaseModel):
    """
    Container for categories with paging information
    """ # noqa: E501
    categories: List[Category] = Field(description="Categories<br/> <strong>Type:</strong> Category")
    paging: Paging = Field(description="Information for pagination<br/> <strong>Type:</strong> Paging")
    __properties: ClassVar[List[str]] = ["categories", "paging"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageableCategoryList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageableCategoryList from a dict"""
        if obj is None:
            return None
