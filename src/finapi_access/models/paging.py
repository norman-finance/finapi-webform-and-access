...
class Paging(BaseModel):
    ...
    per_page: Annotated[int, Field(strict=True, ge=1)] = Field(description="Current page size (number of entries in this page)", alias="perPage")
    page_count: Annotated[int, Field(strict=True, ge=0)] = Field(description="Total number of pages", alias="pageCount")
    total_count: Annotated[int, Field(strict=True, ge=0)] = Field(description="Total number of entries across all pages", alias="totalCount")
