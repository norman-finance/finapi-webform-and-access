...
class PageableKeywordRuleList(BaseModel):
    """
    Container for keyword rule information with paging information
    """ # noqa: E501
    keyword_rules: List[KeywordRule] = Field(description="List of keyword rules<br/> <strong>Type:</strong> KeywordRule", alias="keywordRules")
    paging: Paging = Field(description="Information for pagination<br/> <strong>Type:</strong> Paging")
    __properties: ClassVar[List[str]] = ["keywordRules", "paging"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageableKeywordRuleList from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in keyword_rules (list)
        _items = []
        if self.keyword_rules:
            for _item in self.keyword_rules:
                if _item:
                    _items.append(_item.to_dict())
            _dict['keywordRules'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageableKeywordRuleList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "keywordRules": [KeywordRule.from_dict(_item) for _item in obj["keywordRules"]] if obj.get("keywordRules") is not None else None,
