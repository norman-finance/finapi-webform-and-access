...
class SubmitPaymentParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["paymentId", "bankingInterface", "loginCredentials", "redirectUrl", "multiStepAuthentication"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubmitPaymentParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubmitPaymentParams from a dict"""
        if obj is None:
            return None
