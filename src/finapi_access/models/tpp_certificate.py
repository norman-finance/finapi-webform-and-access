...
class TppCertificate(BaseModel):
    """
    A container for the bank certificate's data
    """ # noqa: E501
    id: StrictInt = Field(description="A certificate identifier.")
    certificate_type: TppCertificateType = Field(description="Type of certificate.<br/> <strong>Type:</strong> TppCertificateType", alias="certificateType")
    label: StrictStr = Field(description="Label of certificate.")
    valid_from: date = Field(description="<strong>Format:</strong> 'YYYY-MM-DD'<br/>Valid from date.", alias="validFrom")
    valid_until: date = Field(description="<strong>Format:</strong> 'YYYY-MM-DD'<br/>Valid until date.", alias="validUntil")
    __properties: ClassVar[List[str]] = ["id", "certificateType", "label", "validFrom", "validUntil"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TppCertificate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TppCertificate from a dict"""
        if obj is None:
            return None
