...
class PageableBankList(BaseModel):
    """
    Container for banks with paging information
    """ # noqa: E501
    banks: List[Bank] = Field(description="Banks<br/> <strong>Type:</strong> Bank")
    paging: Paging = Field(description="Information for pagination<br/> <strong>Type:</strong> Paging")
    __properties: ClassVar[List[str]] = ["banks", "paging"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageableBankList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageableBankList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "banks": [Bank.from_dict(_item) for _item in obj["banks"]] if obj.get("banks") is not None else None,
