...
class PaypalTransactionData(BaseModel):
    ...
    fee: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Fee value.")
    net: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Net value.")
    __properties: ClassVar[List[str]] = ["invoiceNumber", "fee", "net"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaypalTransactionData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaypalTransactionData from a dict"""
        if obj is None:
            return None
