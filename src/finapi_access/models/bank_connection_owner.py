...
class BankConnectionOwner(BaseModel):
    """
    ...
    date_of_birth: Optional[date] = Field(default=None, description="<strong>Format:</strong> 'YYYY-MM-DD'<br/>Date of birth", alias="dateOfBirth")
    post_code: Optional[StrictStr] = Field(default=None, description="Post code", alias="postCode")
    ...
    house_number: Optional[StrictStr] = Field(default=None, description="House number", alias="houseNumber")
    __properties: ClassVar[List[str]] = ["firstName", "lastName", "salutation", "title", "email", "dateOfBirth", "postCode", "country", "city", "street", "houseNumber"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BankConnectionOwner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BankConnectionOwner from a dict"""
        if obj is None:
            return None
