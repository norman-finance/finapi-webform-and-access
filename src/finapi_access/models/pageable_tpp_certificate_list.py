...
class PageableTppCertificateList(BaseModel):
    """
    ...
    tpp_certificates: List[TppCertificate] = Field(description="List of certificates<br/> <strong>Type:</strong> TppCertificate", alias="tppCertificates")
    __properties: ClassVar[List[str]] = ["paging", "tppCertificates"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageableTppCertificateList from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in tpp_certificates (list)
        _items = []
        if self.tpp_certificates:
            for _item in self.tpp_certificates:
                if _item:
                    _items.append(_item.to_dict())
            _dict['tppCertificates'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageableTppCertificateList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "tppCertificates": [TppCertificate.from_dict(_item) for _item in obj["tppCertificates"]] if obj.get("tppCertificates") is not None else None
        })
        return _obj
