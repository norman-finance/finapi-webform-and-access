...
class UserIdentifiersList(BaseModel):
    """
    Container for list of identifiers of deleted users, and not deleted users (in ascending order)
    """ # noqa: E501
    deleted_users: List[StrictStr] = Field(description="List of identifiers of deleted users (in ascending order)", alias="deletedUsers")
    non_deleted_users: List[StrictStr] = Field(description="List of identifiers of not deleted users (in ascending order)", alias="nonDeletedUsers")
    __properties: ClassVar[List[str]] = ["deletedUsers", "nonDeletedUsers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserIdentifiersList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserIdentifiersList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "nonDeletedUsers": obj.get("nonDeletedUsers")
        })
        return _obj
