...
class TppAuthenticationGroup(BaseModel):
    """
    ...
    """ # noqa: E501
    id: StrictInt = Field(description="TPP Authentication Group ID")
    name: StrictStr = Field(description="TPP Authentication Group name")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TppAuthenticationGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TppAuthenticationGroup from a dict"""
        if obj is None:
            return None
