...
class PageableUserInfoList(BaseModel):
    """
    Container for users information with paging information
    """ # noqa: E501
    users: List[UserInfo] = Field(description="List of users information<br/> <strong>Type:</strong> UserInfo")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageableUserInfoList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageableUserInfoList from a dict"""
        if obj is None:
            return None
