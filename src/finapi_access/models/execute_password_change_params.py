...
class ExecutePasswordChangeParams(BaseModel):
    """
    Execute password change parameters
    """ # noqa: E501
    user_id: Annotated[str, Field(min_length=1, strict=True, max_length=36)] = Field(description="User identifier", alias="userId")
    password: Annotated[str, Field(min_length=6, strict=True, max_length=128)] = Field(description="User's new password.")
    password_change_token: Annotated[str, Field(min_length=36, strict=True, max_length=36)] = Field(description="Decrypted password change token (the token that you received from the /users/requestPasswordChange service, decrypted with your data decryption key)", alias="passwordChangeToken")
    __properties: ClassVar[List[str]] = ["userId", "password", "passwordChangeToken"]
    ...
    @field_validator('password_change_token')
    def password_change_token_validate_regular_expression(cls, value):
        """Validates the regular expression"""
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExecutePasswordChangeParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExecutePasswordChangeParams from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "passwordChangeToken": obj.get("passwordChangeToken")
        })
        return _obj
