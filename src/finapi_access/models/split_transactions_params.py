...
class SplitTransactionsParams(BaseModel):
    """
    Set of logical sub-transactions that a transaction should get split into
    """ # noqa: E501
    sub_transactions: List[SubTransactionParams] = Field(description="List of sub-transactions<br/> <strong>Type:</strong> SubTransactionParams", alias="subTransactions")
    __properties: ClassVar[List[str]] = ["subTransactions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SplitTransactionsParams from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in sub_transactions (list)
        _items = []
        if self.sub_transactions:
            for _item in self.sub_transactions:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SplitTransactionsParams from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "subTransactions": [SubTransactionParams.from_dict(_item) for _item in obj["subTransactions"]] if obj.get("subTransactions") is not None else None
        })
        return _obj
