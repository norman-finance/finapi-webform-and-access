...
class VerificationStatusResource(BaseModel):
    """
    User's verification status
    """ # noqa: E501
    user_id: StrictStr = Field(description="User's identifier", alias="userId")
    is_user_verified: StrictBool = Field(description="User's verification status", alias="isUserVerified")
    __properties: ClassVar[List[str]] = ["userId", "isUserVerified"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VerificationStatusResource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VerificationStatusResource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "isUserVerified": obj.get("isUserVerified")
        })
        return _obj
