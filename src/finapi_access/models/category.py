...
class Category(BaseModel):
    ...
    parent_id: Optional[StrictInt] = Field(default=None, description="Identifier of the parent category (if a parent category exists)", alias="parentId")
    parent_name: Optional[StrictStr] = Field(default=None, description="Name of the parent category (if a parent category exists)", alias="parentName")
    is_custom: StrictBool = Field(description="Whether the category is a finAPI global category (in which case this field will be false), or the category was created by a user (in which case this field will be true)", alias="isCustom")
    children: Optional[List[StrictInt]] = Field(default=None, description="List of sub-categories identifiers (if any exist)")
    __properties: ClassVar[List[str]] = ["id", "name", "parentId", "parentName", "isCustom", "children"]
