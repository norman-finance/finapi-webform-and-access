...
class TwoStepProcedure(BaseModel):
    """
    Two-step-procedure for user authorization on bank-side
    """ # noqa: E501
    procedure_id: StrictStr = Field(description="Bank-given ID of the procedure", alias="procedureId")
    procedure_name: StrictStr = Field(description="Bank-given name of the procedure", alias="procedureName")
    procedure_challenge_type: Optional[StrictStr] = Field(default=None, description="The challenge type of the procedure. Possible values are:<br/><br/>&bull; <code>TEXT</code> - the challenge will be a text that contains instructions for the user on how to proceed with the authorization.<br/>&bull; <code>PHOTO</code> - the challenge will contain a BASE-64 string depicting a photo (or any kind of QR-code-like data) that must be shown to the user.<br/>&bull; <code>FLICKER_CODE</code> - the challenge will contain a BASE-64 string depicting a flicker code animation that must be shown to the user.<br/><br/>Note that this challenge type information does not originate from the bank, but is determined by finAPI internally. There is no guarantee that the determined challenge type is correct. Note also that this field may not be set, meaning that finAPI could not determine the challenge type of the procedure.", alias="procedureChallengeType")
    implicit_execute: StrictBool = Field(description="If 'true', then there is no need for your client to pass back anything to finAPI to continue the authorization when using this procedure. The authorization will be dealt with directly between the user, finAPI, and the bank.", alias="implicitExecute")
    __properties: ClassVar[List[str]] = ["procedureId", "procedureName", "procedureChallengeType", "implicitExecute"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TwoStepProcedure from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TwoStepProcedure from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "procedureChallengeType": obj.get("procedureChallengeType"),
            "implicitExecute": obj.get("implicitExecute")
        })
        return _obj
