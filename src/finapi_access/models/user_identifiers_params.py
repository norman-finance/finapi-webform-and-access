...
class UserIdentifiersParams(BaseModel):
    """
    User identifiers params
    """ # noqa: E501
    user_ids: List[StrictStr] = Field(description="List of user identifiers", alias="userIds")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserIdentifiersParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserIdentifiersParams from a dict"""
        if obj is None:
            return None
