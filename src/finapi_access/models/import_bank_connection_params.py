...
class ImportBankConnectionParams(BaseModel):
    """
    Container for bank connection import parameters
    """ # noqa: E501
    bank_id: StrictInt = Field(description="Bank Identifier", alias="bankId")
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(default=None, description="Custom name for the bank connection. If you do not want to set a name, you can leave this field unset.")
    ...
    __properties: ClassVar[List[str]] = ["bankId", "name", "bankingInterface", "loginCredentials", "storeSecrets", "skipBalancesDownload", "skipPositionsDownload", "loadOwnerData", "maxDaysForDownload", "accountTypes", "accountReferences", "multiStepAuthentication", "redirectUrl"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImportBankConnectionParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImportBankConnectionParams from a dict"""
        if obj is None:
            return None
