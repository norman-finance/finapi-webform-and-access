...
class TrainCategorizationData(BaseModel):
    """
    Sample data to train categorization
    """ # noqa: E501
    transaction_data: List[TrainCategorizationTransactionData] = Field(description="Set of transaction data (at most 100 transactions at once)<br/> <strong>Type:</strong> TrainCategorizationTransactionData", alias="transactionData")
    category_id: StrictInt = Field(description="Category identifier", alias="categoryId")
    __properties: ClassVar[List[str]] = ["transactionData", "categoryId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrainCategorizationData from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in transaction_data (list)
        _items = []
        if self.transaction_data:
            for _item in self.transaction_data:
                if _item:
                    _items.append(_item.to_dict())
            _dict['transactionData'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrainCategorizationData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "transactionData": [TrainCategorizationTransactionData.from_dict(_item) for _item in obj["transactionData"]] if obj.get("transactionData") is not None else None,
