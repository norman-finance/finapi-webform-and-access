...
class PageableTransactionList(BaseModel):
    """
    ...
    """ # noqa: E501
    transactions: List[Transaction] = Field(description="Array of transactions (for the requested page)<br/> <strong>Type:</strong> Transaction")
    paging: Paging = Field(description="Information for pagination<br/> <strong>Type:</strong> Paging")
    income: Union[StrictFloat, StrictInt] = Field(description="The total income of all transactions (across all pages)")
    spending: Union[StrictFloat, StrictInt] = Field(description="The total spending of all transactions (across all pages)")
    balance: Union[StrictFloat, StrictInt] = Field(description="The total sum of all transactions (across all pages)")
    __properties: ClassVar[List[str]] = ["transactions", "paging", "income", "spending", "balance"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageableTransactionList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageableTransactionList from a dict"""
        if obj is None:
            return None
