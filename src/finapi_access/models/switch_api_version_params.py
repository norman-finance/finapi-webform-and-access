...
class SwitchApiVersionParams(BaseModel):
    """
    Parameters for switching the API version
    """ # noqa: E501
    api_version: Annotated[str, Field(min_length=1, strict=True, max_length=4)] = Field(description="The target API version to which you want to migrate your client.<br/><br/>Possible values: <code>V1</code>,<code>V2</code>", alias="apiVersion")
    __properties: ClassVar[List[str]] = ["apiVersion"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SwitchApiVersionParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SwitchApiVersionParams from a dict"""
        if obj is None:
            return None
