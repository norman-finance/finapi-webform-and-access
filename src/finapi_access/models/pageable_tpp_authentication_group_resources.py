...
class PageableTppAuthenticationGroupResources(BaseModel):
    """
    TPP Authentication groups with paging information
    """ # noqa: E501
    tpp_authentication_groups: List[TppAuthenticationGroup] = Field(description="List of received TPP authentication groups<br/> <strong>Type:</strong> TppAuthenticationGroup", alias="tppAuthenticationGroups")
    paging: Paging = Field(description="Information for pagination<br/> <strong>Type:</strong> Paging")
    __properties: ClassVar[List[str]] = ["tppAuthenticationGroups", "paging"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageableTppAuthenticationGroupResources from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in tpp_authentication_groups (list)
        _items = []
        if self.tpp_authentication_groups:
            for _item in self.tpp_authentication_groups:
                if _item:
                    _items.append(_item.to_dict())
            _dict['tppAuthenticationGroups'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageableTppAuthenticationGroupResources from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "tppAuthenticationGroups": [TppAuthenticationGroup.from_dict(_item) for _item in obj["tppAuthenticationGroups"]] if obj.get("tppAuthenticationGroups") is not None else None,
