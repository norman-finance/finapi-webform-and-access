...
class IbanRuleList(BaseModel):
    """
    Container for IBAN rules
    """ # noqa: E501
    iban_rules: List[IbanRule] = Field(description="List of IBAN rules<br/> <strong>Type:</strong> IbanRule", alias="ibanRules")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IbanRuleList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IbanRuleList from a dict"""
        if obj is None:
            return None
