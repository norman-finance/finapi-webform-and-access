...
class PageableStandingOrderResources(BaseModel):
    """
    Standing order resources with paging information
    """ # noqa: E501
    standing_orders: List[StandingOrder] = Field(description="List of standing orders<br/> <strong>Type:</strong> StandingOrder", alias="standingOrders")
    paging: Paging = Field(description="Information for pagination<br/> <strong>Type:</strong> Paging")
    __properties: ClassVar[List[str]] = ["standingOrders", "paging"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageableStandingOrderResources from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in standing_orders (list)
        _items = []
        if self.standing_orders:
            for _item in self.standing_orders:
                if _item:
                    _items.append(_item.to_dict())
            _dict['standingOrders'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageableStandingOrderResources from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "standingOrders": [StandingOrder.from_dict(_item) for _item in obj["standingOrders"]] if obj.get("standingOrders") is not None else None,
