...
class CategorizationCheckResults(BaseModel):
    """
    CategorizationCheckResults
    """ # noqa: E501
    categorization_check_result: List[CategorizationCheckResult] = Field(description="List of results<br/> <strong>Type:</strong> CategorizationCheckResult", alias="categorizationCheckResult")
    __properties: ClassVar[List[str]] = ["categorizationCheckResult"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CategorizationCheckResults from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in categorization_check_result (list)
        _items = []
        if self.categorization_check_result:
            for _item in self.categorization_check_result:
                if _item:
                    _items.append(_item.to_dict())
            _dict['categorizationCheckResult'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CategorizationCheckResults from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "categorizationCheckResult": [CategorizationCheckResult.from_dict(_item) for _item in obj["categorizationCheckResult"]] if obj.get("categorizationCheckResult") is not None else None
        })
        return _obj
