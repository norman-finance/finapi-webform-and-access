...
class PasswordChangingResource(BaseModel):
    """
    Password changing details
    """ # noqa: E501
    user_id: StrictStr = Field(description="User identifier", alias="userId")
    user_email: Optional[StrictStr] = Field(default=None, description="User's email, encrypted. Decrypt with your data decryption key. If the user has no email set, then this field will be null.", alias="userEmail")
    password_change_token: StrictStr = Field(description="Encrypted password change token. Decrypt this token with your data decryption key, and pass the decrypted token to the /users/executePasswordChange service to set a new password for the user.", alias="passwordChangeToken")
    __properties: ClassVar[List[str]] = ["userId", "userEmail", "passwordChangeToken"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PasswordChangingResource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PasswordChangingResource from a dict"""
        if obj is None:
            return None
