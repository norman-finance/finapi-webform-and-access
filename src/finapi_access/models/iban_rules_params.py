...
class IbanRulesParams(BaseModel):
    """
    Params for creation of IBAN rules
    """ # noqa: E501
    iban_rules: Annotated[List[IbanRuleParams], Field(min_length=1, max_length=100)] = Field(description="IBAN rule definitions.<br/> <strong>Type:</strong> IbanRuleParams", alias="ibanRules")
    __properties: ClassVar[List[str]] = ["ibanRules"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IbanRulesParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IbanRulesParams from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ibanRules": [IbanRuleParams.from_dict(_item) for _item in obj["ibanRules"]] if obj.get("ibanRules") is not None else None
        })
        return _obj
