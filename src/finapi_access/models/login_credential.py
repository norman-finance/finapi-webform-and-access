...
class LoginCredential(BaseModel):
    ...
    Login credential
    """ # noqa: E501
    label: StrictStr = Field(description="The login field label, as defined by the respective bank interface.")
    value: StrictStr = Field(description="The value for the login field")
