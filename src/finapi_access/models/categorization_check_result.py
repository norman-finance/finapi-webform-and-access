...
class CategorizationCheckResult(BaseModel):
    """
    CategorizationCheckResult
    """ # noqa: E501
    transaction_id: StrictStr = Field(description="The transaction identifier. The transactionId of the transaction that was passed to the service as input. This is not an actual ID of a stored transaction in finAPI, as the checkCategorization service doesn't store any data.", alias="transactionId")
    category: Optional[Category] = Field(default=None, description="A category. The determined transaction category for the given transactionId. This can be null, if the categorization algorithm fails to find a matching rule.<br/> <strong>Type:</strong> Category")
    __properties: ClassVar[List[str]] = ["transactionId", "category"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CategorizationCheckResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CategorizationCheckResult from a dict"""
        if obj is None:
            return None
