...
class PageablePaymentResources(BaseModel):
    """
    Payment resources with paging information
    """ # noqa: E501
    payments: List[Payment] = Field(description="List of received account payments<br/> <strong>Type:</strong> Payment")
    paging: Paging = Field(description="Information for pagination<br/> <strong>Type:</strong> Paging")
    __properties: ClassVar[List[str]] = ["payments", "paging"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageablePaymentResources from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageablePaymentResources from a dict"""
        if obj is None:
            return None
