...
class PageableLabelList(BaseModel):
    """
    Label resources with paging information
    """ # noqa: E501
    labels: List[Label] = Field(description="Labels<br/> <strong>Type:</strong> Label")
    paging: Paging = Field(description="Information for pagination<br/> <strong>Type:</strong> Paging")
    __properties: ClassVar[List[str]] = ["labels", "paging"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageableLabelList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageableLabelList from a dict"""
        if obj is None:
            return None
