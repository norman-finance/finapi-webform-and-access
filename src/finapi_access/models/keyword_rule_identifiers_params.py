...
class KeywordRuleIdentifiersParams(BaseModel):
    """
    Keyword Rule Identifier params
    """ # noqa: E501
    ids: List[StrictInt] = Field(description="List of identifiers")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KeywordRuleIdentifiersParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KeywordRuleIdentifiersParams from a dict"""
        if obj is None:
            return None
