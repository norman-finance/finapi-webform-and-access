...
class IbanRuleParams(BaseModel):
    """
    Parameters of IBAN rule
    """ # noqa: E501
    iban: StrictStr = Field(description="IBAN (case-insensitive)")
    ...
    __properties: ClassVar[List[str]] = ["iban", "categoryId", "direction"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IbanRuleParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IbanRuleParams from a dict"""
        if obj is None:
            return None
