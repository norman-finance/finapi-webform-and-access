...
class PageableTppCredentialResources(BaseModel):
    """
    ...
    tpp_credentials: List[TppCredentials] = Field(description="List of TPP client credentials<br/> <strong>Type:</strong> TppCredentials", alias="tppCredentials")
    __properties: ClassVar[List[str]] = ["paging", "tppCredentials"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageableTppCredentialResources from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in tpp_credentials (list)
        _items = []
        if self.tpp_credentials:
            for _item in self.tpp_credentials:
                if _item:
                    _items.append(_item.to_dict())
            _dict['tppCredentials'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageableTppCredentialResources from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "tppCredentials": [TppCredentials.from_dict(_item) for _item in obj["tppCredentials"]] if obj.get("tppCredentials") is not None else None
        })
        return _obj
