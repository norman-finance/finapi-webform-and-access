...
class BankGroup(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt = Field(description="Bank group identifier")
    name: StrictStr = Field(description="Name of bank group")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BankGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BankGroup from a dict"""
        if obj is None:
            return None
