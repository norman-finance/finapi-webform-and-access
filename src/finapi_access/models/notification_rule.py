...
class NotificationRule(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt = Field(description="Notification rule identifier")
    trigger_event: StrictStr = Field(description="Trigger event type", alias="triggerEvent")
    params: Dict[str, StrictStr] = Field(description="Additional parameters that are specific to the trigger event type. Please refer to the documentation for details.")
    callback_handle: Optional[StrictStr] = Field(default=None, description="The string that finAPI includes into the notifications that it sends based on this rule.", alias="callbackHandle")
    include_details: StrictBool = Field(description="Whether the notification messages that will be sent based on this rule contain encrypted detailed data or not.", alias="includeDetails")
    __properties: ClassVar[List[str]] = ["id", "triggerEvent", "params", "callbackHandle", "includeDetails"]
