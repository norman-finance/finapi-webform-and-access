...
class DeleteConsent(BaseModel):
    """
    Container for a result of the consent deleting
    """ # noqa: E501
    local: DeleteConsentResult = Field(description="Result of consent deletion in the finAPI database (local):<br/><br/>&bull; <code>DELETED</code> - if there was a stored consent and it was deleted.<br/>&bull; <code>NOT_EXIST</code> - if there was no stored consent.<br/><br/> <strong>Type:</strong> DeleteConsentResult")
    remote: DeleteConsentResult = Field(description="Result of consent deletion on the bank's side (remote):<br/><br/>&bull; <code>DELETED</code> - if the consent was successfully deleted on the bank side.<br/>&bull; <code>NOT_SUPPORTED</code> - if the bank doesn't support consent deletion.<br/>&bull; <code>NOT_EXIST</code> - if either there was no remote consent, or there was no local consent (making it impossible to identify any remote consent).<br/>&bull; <code>NOT_DELETED</code> - if the consent couldn't get deleted on the bank side.<br/><br/> <strong>Type:</strong> DeleteConsentResult")
    __properties: ClassVar[List[str]] = ["local", "remote"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteConsent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteConsent from a dict"""
        if obj is None:
            return None
