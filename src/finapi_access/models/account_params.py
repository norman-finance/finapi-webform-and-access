...
class AccountParams(BaseModel):
    ...
    """ # noqa: E501
    account_name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=512)]] = Field(default=None, description="Account name.", alias="accountName")
    account_type: Optional[AccountType] = Field(default=None, description="An account type.<br/><br/>Checking,<br/>Savings,<br/>CreditCard,<br/>Security,<br/>Loan,<br/>Membership,<br/>Bausparen<br/><br/><br/> <strong>Type:</strong> AccountType", alias="accountType")
    is_new: Optional[StrictBool] = Field(default=None, description="Whether this account should be flagged as 'new' or not. Any newly imported account will have this flag initially set to true, and remain so until you set it to false (see PATCH /accounts/<id>). How you use this field is up to your interpretation, however it is recommended to set the flag to false for all accounts right after the initial import of the bank connection. This way, you will be able to recognize accounts that get newly imported during a later update of the bank connection, by checking for any accounts with the flag set to 'true' after every update of the bank connection.", alias="isNew")
    __properties: ClassVar[List[str]] = ["accountName", "accountType", "isNew"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountParams from a dict"""
        if obj is None:
            return None
