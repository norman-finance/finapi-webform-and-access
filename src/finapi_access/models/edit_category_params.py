...
class EditCategoryParams(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = Field(description="New name of the category.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EditCategoryParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EditCategoryParams from a dict"""
        if obj is None:
            return None
