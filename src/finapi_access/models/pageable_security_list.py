...
class PageableSecurityList(BaseModel):
    """
    Container for page of securities
    """ # noqa: E501
    securities: List[Security] = Field(description="List of securities<br/> <strong>Type:</strong> Security")
    paging: Paging = Field(description="Information for pagination<br/> <strong>Type:</strong> Paging")
    __properties: ClassVar[List[str]] = ["securities", "paging"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageableSecurityList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageableSecurityList from a dict"""
        if obj is None:
            return None
